  ...
  return (
      ...
      <section className="bg-white mt-[-2px]">
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
            ...
            <video className="absolute inset-0 h-full w-full object-cover opacity-80" autoPlay loop muted>
              ...
              <div className="hidden lg:relative lg:block lg:p-12">
                ...
                <h2 className="mt-6 text-3xl font-bold text-white sm:text-3xl md:text-4xl">
                  Welcome To A&A House Hunt
                </h2>

                <p className="mt-4 leading-relaxed text-lg text-white/90">
                  A&A House Hunt offers a curated selection of luxury real estate, from elegant estates to modern penthouses. Experience seamless service, exclusive listings, and refined living—your dream home awaits.
                </p>
              </div>
          </section>
          ...
          <main
            className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6 text-lg"
          >
            <div className="max-w-xl lg:max-w-3xl text-lg">

              <SignIn className="text-md"/>
            </div>
          </main>
        </div>
          </section>
